...
/*******************************************************************************
 ** feature.vector.ProbabilityState.java
...
public class ProbabilityState
{
    ...
    /**
     * Constructor for the feature.vector.ProbabilityState class. Takes a data vector and calculates
    ...
    public ProbabilityState(double[] dataVector)
    {
        ...
        //printDoubleVector(dataVector);
        //printIntVector(normalisedVector);
...
}//class feature.vector.ProbabilityState
